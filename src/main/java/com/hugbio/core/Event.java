...
public class Event {
	...
	/*public Exception getmFailException() {
		return mFailException;
	}

	public void setmFailException(Exception mFailException) {
		this.mFailException = mFailException;
	}*/
	...
	public void			setFailException(Exception e){
		////System.out.println("--------------setFailException-----1---"+e.toString());
	...
	public Exception	getFailException(){
		////System.out.println("--------------getFailException--------"+mFailException.toString());
		return mFailException;
	}
