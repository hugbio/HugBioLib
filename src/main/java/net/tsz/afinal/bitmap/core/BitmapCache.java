...
public class BitmapCache {
	...
	private void init(ImageCacheParams cacheParams) {
		...
		if (mCacheParams.memoryCacheEnabled) {
			...
			// mMemoryCache = new
			// SoftMemoryCacheImpl(mCacheParams.memCacheSize);
			// else
			// mMemoryCache = new
			// BaseMemoryCacheImpl(mCacheParams.memCacheSize);
		}
	...
	public Bitmap getBitmapFromMemoryCache(String data) {
		if (mMemoryCache != null){
			BitmapDrawable bitmapDrawable = mMemoryCache.get(data);
...
//                bitmap.recycle();
    ...
    protected Bitmap getBitmapFromReusableSet(BitmapFactory.Options options) {
        ...
        Bitmap bitmap = null;
        bitmap = mMemoryCache.getBitmapFromReusableSet(options);
        return bitmap;
