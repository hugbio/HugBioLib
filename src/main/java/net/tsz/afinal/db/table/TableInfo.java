...
public class TableInfo {
	...
	public static void setAllCheckDatabese(boolean checkDatabese){
		Iterator<String> iterator = tableInfoMap.keySet().iterator();
		while(iterator.hasNext()) {
			TableInfo tableInfo = tableInfoMap.get(iterator.next());
			tableInfo.setCheckDatabese(checkDatabese);
		}
	}
