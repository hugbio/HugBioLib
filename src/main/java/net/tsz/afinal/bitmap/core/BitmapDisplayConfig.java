...
public class BitmapDisplayConfig {
	...
	private String bitmapProcessName = null;

	public String getBitmapProcessName() {
		return bitmapProcessName;
	}

	public void setBitmapProcessName(String bitmapProcessName) {
		this.bitmapProcessName = bitmapProcessName;
	}
